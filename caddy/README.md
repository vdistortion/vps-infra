...
на этот IP, или порты 80/443 закрыты файрволом. Проверьте DNS, firewall
и логи Caddy: для выпуска сертификата Caddy использует доступные ACME-
проверки через публичные HTTP/HTTPS-порты.
